...
Color-based superpixel algorithm for image segmentation. This repository contains a C implementation of FSLIC with a Python interface. The implementation supports multi-channel images ($n_{\text{channels}} \in N$)
<p float="left">
